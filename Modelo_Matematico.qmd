...
::: {style="text-align: justify"}
El sistema está compuesto por dos presas: Angustura $(i = 1)$ y Malpaso [Malpaso](https://es.wikipedia.org/wiki/Presa_Malpaso) $(i =2)$. El volumen de almacenamiento de cada una de ellas en la quincena $q$ del año $t$ se representará por $V_{i,t,q} \in \mathbb{R}_{\geq 0}$ $(Mm^3)$.\\\\
