...
::: {style="text-align: justify"}
Para reducir la dimensionalidad temporal del problema y poder capturar la estacionalidad, las $24$ quincenas se agrupan en $M = 6$ etapas hidrológicas (segmentación temporal del año) mediante la siguiente función de agregación $\mu: \{0,\dots,q-1\} \to \{0,\dots,M-1\}$ definida por $$\mu(q) = \begin{cases} 0, & 0 \leq q <10 & \text{Ene-Mayo}\\ 1, & 10 \leq q <14 & \text{Jun-Jul}\\ 2, & 14 \leq q < 16 & \text{Agosto}\\ 3, & 16 \leq q < 18 & \text{Septiembre}\\ 4, & 18 \leq q < 20 & \text{Octubre}\\ 5, & 20 \leq q \leq 23 & \text{Nov-Dic}\\ \end{cases}$$ {#eq-etapas}
